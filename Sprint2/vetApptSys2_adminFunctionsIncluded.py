...
def admin_after_login_menu():
    ...
    Button(admin_menu,text="not working", width=20, height=1, font="times 20", bd=20, bg="SpringGreen4", command = lambda:vet_update_schedule_clicked()).pack()
    Label(admin_menu,text="").pack()
...
def admin_vet_dropdown_menu():
    ...
    Button(admin_vet_dropdown, text="Return to Main Menu", width = 20, height = 1, font = 'times 20', bd = 20, bg = 'SpringGreen4', command = return_to_main).pack()

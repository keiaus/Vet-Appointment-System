...
for frame in (account_page, account_create, user_log_in, user_pet_menu, user_pet_add,  user_menu, user_update_info, 
              ...
              vet_update_schedule, vet_update_pet, vet_canceled_appointments, admin_log_in, admin_menu, 
...
def create_vetapp():
    ...
    create_button = Button(mainframe, text='Create Account', bd=20, bg="SpringGreen4", width=20, font='times 15', command=lambda:account_creation_clicked())
    user_log_button = Button(mainframe, text='User Log In', bd=20, bg="SpringGreen4", width=20, font='times 15', command=lambda:user_log_in_clicked())

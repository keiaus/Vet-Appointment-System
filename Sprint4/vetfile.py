...
class Vet():
    ...
    def vet_upload_pet_clicked(self):
    ...
    def vet_after_login_menu(self):
        ...
        uppetrec = Button(vetmenuframe, text="Add Pet Record", width=20, height=1, font="times 15", bd=20, bg="SpringGreen4", command = lambda:self.vet_upload_pet_clicked())
...
###########################################################################################################################################################################
    ...
    def upload_pet_rec(self):
        ...
        Label(self.vet_log_in, text="Upload Pet Records", font="times 50 bold", bg="SpringGreen4", anchor=N, pady=50).pack(fill=BOTH)
        Label(self.vet_log_in, text="").pack()
        ...
        self.dob_option_var = tk.StringVar(self)
        self.day_option_var = tk.StringVar(self)
        self.year_option_var = tk.StringVar(self)
        
        for index in range(1, 31):
            self.day.append(index)
        for j in range(1900, date.year):
            self.year_list.append(j)

        pet_dob_label = Label(self.vet_upload_pet_rec, text="Pet's Date of Birth", font = "times 15")

        month_label = Label(self.vet_upload_pet_rec, text="Month", font="times 15")
        month_option = OptionMenu(self.vet_upload_pet_rec, dob_var, default=None, font="times 15")
        month_label.pack()
        month_option.pack()

        pet_day_label = Label(self.vet_upload_pet_rec, text='Pet Weight', font="times 15")
        pet_day_entry = Entry(self.vet_upload_pet_rec, textvariable=pet_color_var, font="times 15")
        pet_day_label.pack()
        pet_day_entry.pack()

        pet_meds_label = Label(self.vet_update_pet, text='Medication Used', font="times 15")
        pet_meds_entry2 = Entry(self.vet_update_pet, textvariable=pet_color_var, font="times 15")
        pet_meds_label.pack()
        pet_meds_entry2.pack()

        pet_notes_label = Label(self.vet_update_pet, text='Notes', font="times 15")
        pet_notes_entry2 = Entry(self.vet_update_pet, textvariable=pet_color_var, font="times 15")
        pet_notes_label.pack()
        pet_notes_entry2.pack()

        pet_outcome_label = Label(self.vet_update_pet, text='Outcome', font="times 15")
        pet_outcome_entry2 = Entry(self.vet_update_pet, textvariable=pet_color_var, font="times 15")
        pet_outcome_label.pack()
        pet_outcome_entry2.pack()

        pet_recom_label = Label(self.vet_update_pet, text='Recommendations', font="times 15")
        pet_recom_entry2 = Entry(self.vet_update_pet, textvariable=pet_color_var, font="times 15")
        pet_recom_label.pack()
        pet_recom_entry2.pack()
...
for frame in (account_page, account_create, user_log_in, user_pet_menu, user_pet_add,  user_menu, user_update_info, 
              ...
              calendar_frame, user_calendar_frame, user_appointment, cancel_menu_frame, vet_daily_appointment, user_pet_record):
    frame.grid(row=0, column=0, sticky='nsew')
    

# creates a user from the user class    
x = user(window, account_page, account_create, user_log_in, user_pet_menu, user_pet_add,  user_menu, user_update_info, user_update_pet_info, user_update_pet_dropdown, user_appointment, user_calendar_frame, cancel_menu_frame, user_searchvet_frame, user_pet_record)

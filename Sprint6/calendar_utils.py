from tkinter import * # gui import to use tkinter
import tkinter as tk # gui import to use tkinter
from tkinter import ttk # necessary for comboboxes
import pyodbc # necessary for aws rds sql server connection
from tkcalendar import Calendar # gui import for calendars (must install tkcalendar "pip install tkcalendar")
from datetime import datetime # necessary for certain calendar functionalities
...
class CalendarUtils():
    ...
    #displays the calendar on click
    ...
    def calendar_display(self):
        ...
        #Command button frame configurations
        ...
        #combobox containing all of the vets
        sel=tk.StringVar()
        ...
        # This function retrieves the VetID, day, and time of vet schedules stored in VetScheduleInfo 
        def schedule_retrieval(event):
            ...
            #Labels and lists for each day which display schedule information
            ...
            #Labels and lists for all of the information related to the selected vet
        ...
        def createScheduleButtons():
            ...
            #switches for selecting the schedules of the vet based on the day selected and sends them to findTimeInterval to be calculated
            match date:
                case 0:
            ...
            #deletes everything in the button frame
            global button_frame
            ...
            #creation of the time slot buttons (here, they're just labels because unregistered users can't create appointments)
            if(temp[0] == "" ):
        ...
        #Takes in the schedule from the selected day and makes calculations for the time slots based on a number of conditions
        def findTimeInterval(my_list2):
            time_interval = 0
            my_list2 = [r for r, in my_list2]
            temp = my_list2[0].split(":")

            #calculations for handling 12/24-hour clock conversions for the time slots based on schedule info

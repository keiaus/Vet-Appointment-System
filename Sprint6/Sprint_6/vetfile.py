...
class vet():
    ...
    def vet_update_schedule_menu(self):
        ...
        updateschedule = tk.Label(self.vet_update_schedule, text = "Update Schedule", font = "times 15")
        updateschedule.pack(side = "top")
        ...
        if(len(my_list) == 0):
            ...
            for i in range(len(my_list)):
                ...
                while (j < y):
                    ...
                    x+=1
                    j=j+1
                Button(label2, text="Upload Pet Record", width=20, height=1, font='times 5', bd=20, bg='SpringGreen4', command = lambda pet_default = str : self.vet_upload_pet_record_clicked(pet_default)).grid(row=j-1, column=2)
            j = 0
...
# This function creates widgets for the vets upload pet records
    def upload_pet_rec(self, pet_default):
        ...
        label = Label(self.vet_upload_pet_rec, text="Upload Pet Records", font="times 35 bold", bg="SpringGreen4", anchor=N, pady=40)
        ...
        Label(labelX, text="").grid(row=0, column=0)
        ...
        pet_dob_label.grid(row=1, column=0)
        pet_dob_entry.grid(row=1, column=1)
        ...
        pet_weight_label.grid(row=2, column=0)
        pet_weight_entry.grid(row=2, column=1)

        pet_meds_label = Label(labelX, text='Medication used:', font="times 15")
        pet_meds_entry = Text(labelX, font="times 15", height="5", width="20")
        pet_meds_label.grid(row=3, column=5)
        pet_meds_entry.grid(row=3, column=6)

        pet_notes_label = Label(labelX, text='Notes:', font="times 15")
        pet_notes_entry = Text(labelX, font="times 15", height="5", width="20")
        pet_notes_label.grid(row=4, column=5)
        pet_notes_entry.grid(row=4, column=6)
        ...
        pet_outcome_label.grid(row=3, column=0)
        pet_outcome_entry.grid(row=3, column=1)

        pet_recom_label = Label(labelX, text='Recommendations', font="times 15")
        pet_recom_entry = Text(labelX, font="times 15", height="5", width="20")
        pet_recom_label.grid(row=4, column=0)
        pet_recom_entry.grid(row=4, column=1)
        ...
        butt.grid(row = 12, column = 2)
        Button(labelX, text="Go Back", width=20, height=1, font='times 15', bd=20, bg='SpringGreen4', command = self.vet_daily_appointment_clicked).grid(row = 12, column = 3)
